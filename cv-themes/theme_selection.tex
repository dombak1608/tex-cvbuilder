...
\newcommand{\aboutpersonal}[1]{\renewcommand{\aboutpersonal}{#1}}
\newcommand{\aboutpersonalprojects}[1]{\renewcommand{\aboutpersonalprojects}{#1}}
...
\newcommand{\makeabout}[1]{\ifthenelse{\equal{\aboutdesc}{}}{}{%
    ...
    \aboutdesc}}
\newcommand{\makepersonal}[1]{\ifthenelse{\equal{\aboutpersonal}{}}{}{%
    \subsection{#1}

\aboutpersonal}}
\newcommand{\makepersonalprojects}[1]{\ifthenelse{\equal{\aboutpersonalprojects}{}}{}{%
    \subsection{#1}

\aboutpersonalprojects}}
...
\newcommand{\sitemtit}{\color{bodytext}\sffamily}
...
\setlist[itemize,1]{label={\color{bulletcolor}$\bullet$},parsep=1pt,labelindent=6pt}
\setlist[itemize,2]{label={\color{bulletcolor}$\bullet$},parsep=1pt,labelindent=6pt}
\setlist[itemize,3]{label={\color{bulletcolor}$\bullet$},parsep=1pt,labelindent=6pt}
